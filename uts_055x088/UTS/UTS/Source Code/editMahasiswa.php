...
<form action="updateMahasiswaBckn.php" method="POST">
                            ...
                            <form action="prosesMahasiswa.php" method="POST">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control"
                                        placeholder="NIM" name="nim" value="<?= $data['nim']?>" readonly/>
                                    <label for="nim">NIM</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control"
                                        placeholder="Nama" name="nama" value="<?= $data['nama_mhs']?>"/>
                                ...
                                <div class="form-floating mb-3">
                                    <select class="form-control" name="jurusan" id="jurusan">
                                        ...
                                        <option value="001">Sistem Konputer</option>
                                        <option value="002">Sistem Informasi</option>
                                        <option value="003">Bisnis Digital</option>
