...
$qry = "SELECT * FROM karyawan WHERE nik = '$nik'";
...
<form action="updateKaryawanBckn.php" method="POST">
                            ...
                            <form action="prosesKaryawan.php" method="POST">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control"
                                        placeholder="NIK" name="nik" value="<?= $data['nik']?>" readonly/>
                                    <label for="nik">NIK</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control"
                                        placeholder="Nama" name="nama" value="<?= $data['nama_krwn']?>"/>
